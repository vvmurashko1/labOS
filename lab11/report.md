...
![Создание файла и дача ему права](image/02.png){ #fig:001 width=70% }

![Скрипт 1](image/03.png){ #fig:001 width=70% }

![Скрипт в домашней папке](image/04.png){ #fig:001 width=70% }
...
![Скрипт 2](image/05.png){ #fig:001 width=70% }

![Вывод всех переданных аргументов](image/06.png){ #fig:001 width=70% }
...
![Информация](image/08.png){ #fig:001 width=70% }
...
![Скрипт 3](image/09.png){ #fig:001 width=70% }

![Вычисление количества файлов](image/10.png){ #fig:001 width=70% }
